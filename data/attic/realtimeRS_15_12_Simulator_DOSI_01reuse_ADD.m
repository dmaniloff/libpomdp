...
logFilename = sprintf('simulation-logs/rocksample/realtime-LOG-15-12-rs-%s-DOSI-%.1freuse-ADD.log',...
                      date, REUSETHRESHOLD);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/realtime-ALLSTATS-15-12-rs-%s-DOSI-%.1freuse-ADD.mat',...
            date, REUSETHRESHOLD);
