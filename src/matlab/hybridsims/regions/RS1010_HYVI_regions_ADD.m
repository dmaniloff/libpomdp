...
EXPANSION_RATE       = 25; % calculated from the online simulator, avg 
AVG_EP_LIFETIME      = 30; % calculated from the online simulator, avg
EPSILON_ACT_TH       = 1e-3;
EPISODECOUNT         = 5;
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/RS1010-ALLSTATS-HYVI-regions-ADD-%s.mat', datestr(now, 'yyyy-mmm-dd-HHMMSS'));
