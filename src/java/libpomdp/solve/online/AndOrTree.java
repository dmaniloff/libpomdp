...
public class AndOrTree {
	...
	this.root.u = offlineUpper.value(this.root.getBeliefState());
	this.root.l = offlineLower.value(this.root.getBeliefState());
	...
	for (HeuristicSearchOrNode o : a.getChildren()) {
	    ...
	    if (o != null)
		Lba += o.getBeliefState().getPoba() * o.l;
	}
	...
	for (HeuristicSearchOrNode o : a.getChildren()) {
	    // o.belief.getpoba() == 0 for null HeuristicSearchOrNodes anyway
	    if (o != null)
		Uba += o.getBeliefState().getPoba() * o.u;
	}
