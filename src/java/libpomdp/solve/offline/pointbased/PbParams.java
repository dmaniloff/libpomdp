...
public class PbParams {
    ...
    public PbParams(int backupMethod, int expandMethod, int backupHorizon,
	    int maxTotalPoints, int maxNewPoints, boolean newPointsOnly) {
	super();
    ...
    public PbParams(int backupMethod, int expandMethod, int backupHorizon,
	    int maxTotalPoints) {
	this(backupMethod, expandMethod, backupHorizon, maxTotalPoints,
		Integer.MAX_VALUE, false);
    }

    public PbParams(int backupMethod, int expandMethod, int backupHorizon,
	    int maxTotalPoints, int maxNewPoints) {
	this(backupMethod, expandMethod, backupHorizon, maxTotalPoints,
		maxNewPoints, false);
    }
