...
logFilename = sprintf('simulation-logs/coffee/realtime-LOG-coffee-%s-DOSI-RANDreuse-ADD.log',...
                      date);
diary(logFilename);
...
statsFilename = ...
    sprintf('simulation-logs/coffee/realtime-ALLSTATS-coffee-%s-DOSI-RANDreuse-ADD.mat',...
            date);
