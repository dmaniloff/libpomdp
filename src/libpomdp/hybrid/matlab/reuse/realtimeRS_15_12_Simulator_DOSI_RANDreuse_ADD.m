...
%% load saved bounds
load '../../problems/rocksample/15-12/blindAdd_RockSample_10_10.mat';
load '../../problems/rocksample/15-12/qmdpSymPerseus_RockSample_10_10.mat';
...
logFilename = sprintf('simulation-logs/rocksample/realtime-LOG-15-12-rs-%s-DOSI-RANDreuse-ADD.log',...
                      date);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/realtime-ALLSTATS-15-12-rs-%s-DOSI-RANDreuse-ADD.mat',...
            date);
