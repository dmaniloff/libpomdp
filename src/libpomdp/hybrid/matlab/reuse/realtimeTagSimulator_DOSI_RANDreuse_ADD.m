...
% libpomdp
% ========
% File: realtimeTagSimulator_DOSI_01reuse_ADD.m
...
import libpomdp.problems.catchproblem.*;
...
logFilename = sprintf('simulation-logs/catchproblem/realtime-LOG-tag-%s-DOSI-RANDreuse-ADD.log',...
                      date);
diary(logFilename);
...
statsFilename = ...
    sprintf('simulation-logs/catchproblem/realtime-ALLSTATS-tag-%s-DOSI-RANDreuse-ADD.mat',...
            date);
