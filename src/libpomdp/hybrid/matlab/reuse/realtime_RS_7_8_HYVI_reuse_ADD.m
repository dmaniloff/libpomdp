function realtime_RS_7_8_HYVI_reuse_ADD(REUSETHRESHOLD, USE_FACTORED_BELIEFS)
...
logFilename = sprintf('simulation-logs/rocksample/realtime-LOG-7-8-rs-%s-HYVI-%.1freuse-ADD.log',...
                      date, REUSETHRESHOLD);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/realtime-ALLSTATS-7-8-rs-%s-HYVI-%.1freuse-ADD.mat',...
            date, REUSETHRESHOLD);
