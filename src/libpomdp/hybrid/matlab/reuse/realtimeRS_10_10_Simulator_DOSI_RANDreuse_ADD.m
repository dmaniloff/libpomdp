...
%% load saved bounds
load '../../problems/rocksample/10-10/blindAdd_RockSample_10_10.mat';
load '../../problems/rocksample/10-10/qmdpSymPerseus_RockSample_10_10.mat';
...
logFilename = sprintf('simulation-logs/rocksample/realtime-LOG-10-10-rs-%s-DOSI-RANDreuse-ADD.log',...
                      date);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/realtime-ALLSTATS-10-10-rs-%s-DOSI-RANDreuse-ADD.mat',...
            date);
