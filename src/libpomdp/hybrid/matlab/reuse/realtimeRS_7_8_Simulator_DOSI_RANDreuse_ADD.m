...
%% load saved bounds
load '../../problems/rocksample/7-8/blindAdd_RockSample_7_8.mat';
load '../../problems/rocksample/7-8/qmdpSymPerseus_RockSample_7_8.mat';
...
logFilename = sprintf('simulation-logs/rocksample/realtime-LOG-7-8-rs-%s-DOSI-RANDreuse-ADD.log',...
                      date);
...
for run = 1:TOTALRUNS
    ...
    for ep = 1:EPISODECOUNT
        ...
        % re - initialize tree at starting belief - use factored beliefs
        aoTree = [];
        aoTree = AndOrTreeUpdateAdd(factoredProb, aems2h, dosih, ...
                                    lBound, uBound);
        ...
        for iter = 1:MAXEPISODELENGTH
            ...
            if rootNode.belief.getClass.toString == 'class libpomdp.common.java.add.BelStateFactoredAdd'
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/realtime-ALLSTATS-7-8-rs-%s-DOSI-RANDreuse-ADD.mat',...
            date);
