function realtime_RS_15_12_HYVI_reuse_ADD(REUSETHRESHOLD, USE_FACTORED_BELIEFS)
% --------------------------------------------------------------------------- %
% libpomdp
% ========
% File: .m
...
logFilename = sprintf('simulation-logs/rocksample/realtime-LOG-15-12-rs-%s-HYVI-%.1freuse-ADD.log',...
                      date, REUSETHRESHOLD);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/realtime-ALLSTATS-15-12-rs-%s-HYVI-%.1freuse-ADD.mat',...
            date, REUSETHRESHOLD);
