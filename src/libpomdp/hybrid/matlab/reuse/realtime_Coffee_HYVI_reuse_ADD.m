function realtime_Coffee_HYVI_reuse_ADD(REUSETHRESHOLD, USE_FACTORED_BELIEFS)

% --------------------------------------------------------------------------- %
% libpomdp
% ========
% File: realtime_Cofee_HYVI_reuse_ADD
% Description: hybrid value iteration simulation for
% CoffeeDelivery using ADDs
...
load '../../problems/coffee/coffee_blind_ADD.mat';
load '../../problems/coffee/coffee_qmdp_ADD.mat';
...
logFilename = sprintf('simulation-logs/coffee/realtime-LOG-coffee-%s-HYVI-%.1freuse-ADD.log',...
                      date, REUSETHRESHOLD);
diary(logFilename);
...
statsFilename = ...
    sprintf('simulation-logs/coffee/realtime-ALLSTATS-coffee-%s-HYVI-%.1freuse-ADD.mat',...
            date, REUSETHRESHOLD);
