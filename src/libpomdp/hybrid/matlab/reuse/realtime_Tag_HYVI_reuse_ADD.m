function realtime_Tag_HYVI_reuse_ADD(REUSETHRESHOLD, USE_FACTORED_BELIEFS)
% --------------------------------------------------------------------------- %
% libpomdp
% ========
% File: realtime_Tag_HYVI_reuse_ADD.m
...
load '../../problems/catchproblem/catch_tag_taggingAction_blind_ADD.mat'
load '../../problems/catchproblem/catch_tag_taggingAction_qmdp_ADD.mat'
...
logFilename = sprintf('simulation-logs/catchproblem/realtime-LOG-tag-%s-HYVI-%.1freuse-ADD.log',...
                      date, REUSETHRESHOLD);
diary(logFilename);
...
statsFilename = ...
    sprintf('simulation-logs/catchproblem/realtime-ALLSTATS-tag-%s-HYVI-%.1freuse-ADD.mat',...
            date, REUSETHRESHOLD);
