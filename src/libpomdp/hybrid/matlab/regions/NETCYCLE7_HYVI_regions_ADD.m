...
logFilename = sprintf('simulation-logs/network/NETCYCLE%d-HYVI-regions-ADD-%s.log',...
...
statsFilename = ...
    sprintf('simulation-logs/network/NETCYCLE%d-ALLSTATS-HYVI-regions-ADD-%s.mat',...
            NUM_MACHINES, datestr(now, 'yyyy-mmm-dd-HHMMSS'));
