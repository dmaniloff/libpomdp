...
%% play the pomdp
logFilename = sprintf('simulation-logs/rocksample/RS710-HYVI-regions-always-ADD-%s.log', datestr(now, 'yyyy-mmm-dd-HHMMSS'));
diary(logFilename);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/RS710-ALLSTATS-HYVI-regions-always-ADD-%s.mat', datestr(now, 'yyyy-mmm-dd-HHMMSS'));
