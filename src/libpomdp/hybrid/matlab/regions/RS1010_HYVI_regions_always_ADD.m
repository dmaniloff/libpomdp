...
%% play the pomdp
logFilename = sprintf('simulation-logs/rocksample/RS1010-HYVI-regions-always-ADD-%s.log', datestr(now, 'yyyy-mmm-dd-HHMMSS'));
diary(logFilename);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/RS1010-ALLSTATS-HYVI-regions-always-ADD-%s.mat', datestr(now, 'yyyy-mmm-dd-HHMMSS'));
