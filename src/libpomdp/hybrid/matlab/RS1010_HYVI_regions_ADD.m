...
logFilename = sprintf('simulation-logs/rocksample/RS1010-HYVI-regions-ADD-%s.log', date);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/RS1010-ALLSTATS-HYVI-regions-ADD-%s.mat', date);
