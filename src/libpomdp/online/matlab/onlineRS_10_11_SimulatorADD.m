...
%% play the pomdp
logFilename = sprintf('simulation-logs/rocksample/RS1011-online-AEMS2-ADD-%s.log', datestr(now, 'yyyy-mmm-dd-HHMMSS'));
diary(logFilename);
...
statsFilename = ...
    sprintf('simulation-logs/rocksample/RS1011-online-ALLSTATS-AEMS2-ADD-%s.mat', datestr(now, 'yyyy-mmm-dd-HHMMSS'));
